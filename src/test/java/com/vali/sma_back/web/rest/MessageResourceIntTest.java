...
import com.vali.sma_back.service.MessageService;
...
public class MessageResourceIntTest {
    ...
    private static final Long UPDATED_TIMESTAMP_MILLIS = 2L;
    ...
    public static Message createEntity(EntityManager em) {
        Message message = new Message()
            .text(DEFAULT_TEXT)
            .timestampMillis(DEFAULT_TIMESTAMP_MILLIS);
        return message;
    }
    ...
    public void createMessage() throws Exception {
        ...
        assertThat(testMessage.getTimestampMillis()).isEqualTo(DEFAULT_TIMESTAMP_MILLIS);
    }
    ...
    @Test
    @Transactional
    public void checkTimestampMillisIsRequired() throws Exception {
        int databaseSizeBeforeTest = messageRepository.findAll().size();
        // set the field null
        message.setTimestampMillis(null);
    ...
    public void getAllMessages() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].timestampMillis").value(hasItem(DEFAULT_TIMESTAMP_MILLIS.intValue())));
    }
    ...
    public void getMessage() throws Exception {
        ...
        restMessageMockMvc.perform(get("/api/messages/{id}", message.getId()))
            ...
            .andExpect(jsonPath("$.timestampMillis").value(DEFAULT_TIMESTAMP_MILLIS.intValue()));
    }
    ...
    public void updateMessage() throws Exception {
        ...
        updatedMessage
            .text(UPDATED_TEXT)
            .timestampMillis(UPDATED_TIMESTAMP_MILLIS);
        ...
        assertThat(testMessage.getTimestampMillis()).isEqualTo(UPDATED_TIMESTAMP_MILLIS);
    }
